 ...
 * <p>
 * Although not part of the HTML spec, table org.xito.dialog.layouts can define <b>min-min_width, min-max_height, max-min_width, and max-max_height </b>
 ...
 * </p>
 * <p>
 * Tip: In order to help test org.xito.dialog.layouts in a browser set the table border="1".
 * </p>
 * @author Deane Richan
 */
public class TableLayout implements LayoutManager2 {
    ...
    public static TableLayout createLayout(String name) {
       return new TableLayout(TableLayout.class.getResource("/org/xito/dialog/layouts/" + name + ".html"));
    }
    ...
    public Dimension maximumLayoutSize(Container target) {
        ...
        calculatePositions(target);
        return new Dimension(maxCalculatedWidth, maxCalculatedHeight);
    }
    ...
    private Dimension getSize(Container target) {
        ...
        if (width > 1) {
            ...
            dim.width = (int) (width * target.getWidth());
        }
        ...
        if (height > 1) {
            ...
            dim.height = (int) (height * target.getHeight());
        }
    ...
    private Point getOrigin(Dimension size, Container target) {
        ...
        if (anchor == NORTH_WEST) {
            ...
            origin.x = target.getWidth() - size.width;
            origin.y = 0;
        }
        else if (anchor == EAST) {
            origin.x = target.getWidth() - size.width;
            origin.y = ((target.getHeight() - size.height) / 2);
        }
        else if (anchor == SOUTH_EAST) {
            origin.x = target.getWidth() - size.width;
            origin.y = target.getHeight() - size.height;
        }
