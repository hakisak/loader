...
public class PropsLayout {
   ...
   public static void main(String args[]) {
      ...
      contentPane.add("prop_1", new JTextField("Property Value 1", 20));
      contentPane.add("prop_2", new JTextField("Property Value 2", 20));
      contentPane.add("prop_3", new JTextField("Property Value 3", 20));
