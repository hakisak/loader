 ...
 * @author DRICHAN
 */
public class JNLPActionBeanInfo extends SimpleBeanInfo {
   ...
   public JNLPActionBeanInfo() {
      desc = new BeanDescriptor(JNLPAction.class, JNLPConfigDialog.class);
      desc.setDisplayName(Resources.jnlpBundle.getString("action.display.name"));
   }
