 ...
 * @author DRICHAN
 */
public class AppletActionBeanInfo extends SimpleBeanInfo {
   ...
   public AppletActionBeanInfo() {
      desc = new BeanDescriptor(AppletAction.class, AppletConfigDialog.class);
      desc.setDisplayName(Resources.appletBundle.getString("action.display.name"));
   }
