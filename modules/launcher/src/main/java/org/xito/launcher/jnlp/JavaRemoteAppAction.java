 ...
 * @author Deane Richan
 */
public class JavaRemoteAppAction extends LauncherAction {

   private static final Logger logger = Logger.getLogger(JavaRemoteAppAction.class.getName());
         
   /** Creates a new instance of JavaAppAction */
   public JavaRemoteAppAction(JavaRemoteAppActionFactory factory) {
      this(factory, new JavaAppDesc());
   }
   
   /** Creates a new instance of AppletAction */
   public JavaRemoteAppAction(JavaRemoteAppActionFactory factory, JavaAppDesc desc) {
      super(factory);
      setLaunchDesc(desc);
      super.putValue(super.SMALL_ICON, JavaRemoteAppActionBeanInfo.icon16);
   }
   ...
   public void actionPerformed(ActionEvent evt) {
      ...
      if(appDesc.getAppDescURL() == null) {
         DialogManager.showError(null, Resources.javaBundle.getString("launch.error.title"), Resources.javaBundle.getString("remote.config.org.xito.address.error"), null);
         return;
      }
