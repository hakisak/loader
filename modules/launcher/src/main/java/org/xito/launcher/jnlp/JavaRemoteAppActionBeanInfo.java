 ...
 * @author DRICHAN
 */
public class JavaRemoteAppActionBeanInfo extends SimpleBeanInfo {
   ...
   /** Creates a new instance of JavaRemoteAppActionBeanInfo */
   public JavaRemoteAppActionBeanInfo() {
      desc = new BeanDescriptor(JavaAppAction.class, JavaConfigDialog.class);
      desc.setDisplayName(Resources.javaBundle.getString("remote.action.display.name"));
   }
