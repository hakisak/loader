...
public class ServiceStarter {
   ...
   public static List<ServiceStartException> startServices(URL servicesURL, boolean failOnException, boolean cacheServiceCode) {
      ...
      if(servicesURL.getProtocol().equals("http")) {
         try {
            ...
            servicesURL = Boot.getCacheManager().getCachedFileForURL(servicesURL).toURI().toURL();
         }
   ...
   public static ServiceDesc startService(ServiceDescStub serviceRef) throws ServiceStartException {
	   ...
	   try {
		   ...
		   if(serviceURL.getProtocol().equals("http")) {
		       ...
		       serviceURL = Boot.getCacheManager().getCachedFileForURL(serviceURL).toURI().toURL();
		   }
	   }
   ...
   private static URL getURL(String uri) {
      ...
      try {
         ...
         try {
            url = new URL(Boot.getBootDir().toURI().toURL(), uri);
         }
         catch(Exception e) {
            e.printStackTrace();
         }
