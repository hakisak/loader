...
public class BootPolicy extends Policy {
   ...
   protected BootPolicy(BootSecurityManager securityManager) {
      ...
      try {
         ...
         logger.log(Level.INFO, String.format("BootDir CodeSource:%s", bootDirSource.getLocation()));
         logger.log(Level.INFO, String.format("BootStrapLoader: %s", bootStrapLoader.toString()));
      }
   ...
   public boolean implies(ProtectionDomain domain, Permission permission) {
      ...
      System.out.println(domain.getClassLoader() + "---------- "+domain.getCodeSource());
      ...
      if(permissions.implies(permission)) {
         ...
         System.out.println("******* NOT Granting "+permission.getName()+" to codesource:"+domain.getCodeSource());
   ...
   private final class PermissionHandler implements PrivilegedAction {
      ...
      private boolean codeSourceCheckImplies(CodeSource cs) {
         ...
         try {
            String bootdirStr = Boot.getBootDir().toURI().toURL().toString();
