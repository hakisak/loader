 ...
 * @author Deane Richan
 */
public class SoftVector extends AbstractList {
   ...
   public Object get(int index) {
      SoftReference ref = (SoftReference)list.get(index);
   ...
   public void add(int index, Object obj) {
      list.add(index, new SoftReference(obj));
   ...
   public boolean removeObject(Object obj) {
      ...
      if(i>=0) {
    	  SoftReference ref = (SoftReference)super.remove(i);
         if(ref != null) {
            return true;
         }
      }
