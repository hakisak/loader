...
public abstract class AutoCompleteFilter extends DocumentFilter {
    ...
    *         the user entered string (-1 if no object is currently being used
    *         as a match)
    */
   ...
   protected String _preText; // The text in the input field before we started
                              // last looking for matches.
