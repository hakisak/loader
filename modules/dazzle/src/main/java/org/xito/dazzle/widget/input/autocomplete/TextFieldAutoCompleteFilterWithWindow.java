...
public class TextFieldAutoCompleteFilterWithWindow extends TextFieldAutoCompleteFilter {

   public TextFieldAutoCompleteFilterWithWindow(Object[] completerObjs, JTextField textField) {
   ...
   private void _initWindow() {
      ...
      _sp = new JScrollPane(_list, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED, JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
   ...
   private void _setWindowHeight() {
      ...
      _sp.setSize(_textField.getWidth(), height); // bottom border fails to draw
                                                  // without this
   }
   ...
   private class FilterWindowListener extends MouseAdapter implements AncestorListener, FocusListener,
         WindowFocusListener {
