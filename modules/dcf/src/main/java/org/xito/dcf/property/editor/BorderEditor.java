...
public class BorderEditor extends EditorSupport
{
  ...
  Border borders[] =
  {
    ...
    private JComboBox createComboBox()
    {
      ...
      c.setPreferredSize(EditorSupport.MEDIUM_DIMENSION); // new Dimension(120,20));
      c.setMinimumSize(EditorSupport.MEDIUM_DIMENSION);
      c.setMaximumSize(EditorSupport.MEDIUM_DIMENSION);
