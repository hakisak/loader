 ...
 */
public class ColorEditor extends EditorSupport
{
  ...
  private void createComponents()
  {
    ...
    rgbValue.setPreferredSize(EditorSupport.MEDIUM_DIMENSION);
    rgbValue.setMaximumSize(EditorSupport.MEDIUM_DIMENSION);
    rgbValue.setMinimumSize(EditorSupport.MEDIUM_DIMENSION);
    colorChooserCombo.setPreferredSize(EditorSupport.SMALL_DIMENSION);
    colorChooserCombo.setMaximumSize(EditorSupport.SMALL_DIMENSION);
    colorChooserCombo.setMinimumSize(EditorSupport.SMALL_DIMENSION);
  ...
  class ChooserComboButton extends JButton
  {
    ...
    {
      super ("");
      popup = new ChooserComboPopup(getColorEditor());
